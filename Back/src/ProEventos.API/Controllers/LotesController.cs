        ...
        public async Task<IActionResult>  Get(int eventoId)
        {
         ...
         public async Task<IActionResult> SaveLotes(int eventoId, LoteDto[] models ){
           try
           {
            ...
            if(lotes == null) return BadRequest("Erro ao tentar realizar update do evento");
            return Ok(lotes);
           ...
           return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar salvar lotes.{ex.Message}");
           }
        }
         ...
         public async Task<IActionResult> Delete(int eventoId, int loteId){
           ...
           return await _loteService.DeleteLote(lote.EventoId, lote.Id)
             ...
             : throw new Exception("Ocorreu um problema não especificado ao tentar deltar o lote.");
